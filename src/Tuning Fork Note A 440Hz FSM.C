...
#define S0 0    // switch not pressed
#define S1 1    // switch pressed, led toggles
#define S2 2    // switch released, led continues to toggle
#define S3 3    // switch pressed again, led stops toggling
STyp FSM[4]={
 {0x00,{S0,S1}},
 {0x01,{S2,S1}},
 {0x01,{S2,S3}},
