...
// Pressing SW1 and SW2 starts SOS (Yellow LED flashes SOS).
...
// If either SW1 or SW2 is not pressed stops SOS

// Authors: Ben Fridolin
// Date: August 26, 2016
...
int main(void)
{
  ...
  while (1)
  {
    ...
    } while (SW1 == 0x10 || SW2 == 0x01); // if either SW1 or Sw2 not pressed
    do
    {
      FlashSOS();
      SW1 = GPIO_PORTF_DATA_R & 0x10;     // PF4 into SW1
      SW2 = GPIO_PORTF_DATA_R & 0x01;     // PF0 into SW2
    } while (SW1 == 0x10 && SW2 == 0x01); // Both SW1 and SW2 pressed
  }
}
